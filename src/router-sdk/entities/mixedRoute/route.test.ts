...
describe('MixedRoute', () => {
  ...
  describe('path', () => {
    ...
    it('wraps complex mixed route object and successfully constructs a path from the tokens', () => {
      const route = new MixedRouteSDK(
        [pool_0_1, pair_1_weth, pair_weth_2],
        token0,
        token2
      );
    ...
    it('wraps complex mixed route object with multihop V3 in the beginning and constructs a path', () => {
      const route = new MixedRouteSDK(
        [pool_0_1, pool_1_weth, pair_weth_2],
        token0,
        token2
      );
    ...
    it('wraps complex mixed route object with multihop V2 in the beginning and constructs a path', () => {
      const route = new MixedRouteSDK(
        [pair_0_1, pair_1_weth, pool_2_weth],
        token0,
        token2
      );
    ...
    it('wraps complex mixed route object with consecutive V3 in the middle and constructs a path', () => {
      const route = new MixedRouteSDK(
        [pair_0_1, pool_1_weth, pool_2_weth, pair_2_3],
        token0,
        token3
      );
  ...
  it('can have a token as both input and output', () => {
    const route = new MixedRouteSDK(
      [pair_0_weth, pair_0_1, pair_1_weth],
      weth,
      weth
    );
  ...
  describe('is backwards compatible with a 100% V3 route', () => {
    ...
    it('can have a token as both input and output', () => {
      const routeOriginal = new V3RouteSDK(
        [pool_0_weth, pool_0_1, pool_1_weth],
        weth,
        weth
      );
      const route = new RouteV3(routeOriginal);
  ...
  describe('#midPrice', () => {
    ...
    describe('100% V3 pool route', () => {
      it('correct for 0 -> 1', () => {
        ...
        expect(route.midPrice.toFixed(4)).toEqual(
          routeV3SDK.midPrice.toFixed(4)
        );
      ...
      it('correct for ether -> 0 -> 1 -> weth', () => {
        const routeV3SDK = new V3RouteSDK(
          [pool_0_weth, pool_0_1, pool_1_weth],
          ETHER,
          weth
        );
    ...
    describe('100% V2 pair route', () => {
      it('correct for 0 -> 1', () => {
        ...
        const route = new MixedRouteSDK([pair_0_1], token0, token1);
        expect(routeV2SDK.midPrice.toFixed(4)).toEqual(
          route.midPrice.toFixed(4)
        );
      ...
      it('correct for ether -> 0 -> 1 -> weth', () => {
        const routeV2SDK = new V2RouteSDK(
          [pair_0_weth, pair_0_1, pair_1_weth],
          ETHER,
          weth
        );
  ...
  describe('partitionMixedRouteByProtocol', () => {
    ...
    it('returns correct for route of all the v3 pools', () => {
      const route = new MixedRouteSDK(
        [pool_0_1, pool_1_weth, pool_2_weth],
        token0,
        token2
      );
