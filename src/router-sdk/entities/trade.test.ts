...
describe('Trade', () => {
  ...
  describe('#fromRoute', () => {
    ...
    it('throws if input currency does not match for V2 Route', async () => {
      ...
      await expect(
        Trade.fromRoute(route, amount, TradeType.EXACT_INPUT)
    ...
    it('throws if output currency does not match for V2 Route', async () => {
      ...
      await expect(
        Trade.fromRoute(route, amount, TradeType.EXACT_OUTPUT)
    ...
    it('throws if input currency does not match for V3 route', async () => {
      ...
      await expect(Trade.fromRoute(route, amount, tradeType)).rejects.toThrow(
        'INPUT'
      );
    });
  ...
  describe('#fromRoutes', () => {
    it('can contain both a v2 and a v3 route', async () => {
      const routeOriginalV2 = new V2RouteSDK(
        [pair_0_1, pair_1_2],
        token0,
        token2
      );
      ...
      const routeOriginalV3 = new V3RouteSDK(
        [pool_0_1, pool_1_2],
        token0,
        token2
      );
      ...
      const outv2 = pair_1_2.getOutputAmount(
        pair_0_1.getOutputAmount(amountv2)[0]
      )[0];
    ...
    it('can contain a v2, a v3, and a mixed route', async () => {
      ...
      const mixedRouteOriginal = new MixedRouteSDK(
        [pool_weth_0, pair_weth_2],
        token0,
        token2
      );
      const mixedRoute = new MixedRoute(mixedRouteOriginal);
      const amountMixedRoute = CurrencyAmount.fromRawAmount(
        token0,
        JSBI.BigInt(1000)
      );
    ...
    it('can contain multiple v2, v3, and mixed routes', async () => {
      ...
      const mixedRoute2Original = new MixedRouteSDK(
        [pool_0_3, pair_2_3],
        token0,
        token2
      );
      const mixedRoute2 = new MixedRoute(mixedRoute2Original);
      const amountMixedRoute2 = CurrencyAmount.fromRawAmount(
        token0,
        JSBI.BigInt(1000)
      );

      const amountIn = amountv2
        .add(amountv3)
        .add(amountMixedRoute)
        .add(amountMixedRoute2);
    ...
    it('can contain muliptle v2 and v3 routes', async () => {
      ...
      const route2OriginalV2 = new V2RouteSDK(
        [pair_weth_0, pair_weth_2],
        token0,
        token2
      );
      ...
      const route2OriginalV3 = new V3RouteSDK(
        [pool_weth_0, pool_weth_2],
        token0,
        token2
      );
      ...
      const amountOutExpected = amountv2
        .add(amount2v2)
        .add(amountv3)
        .add(amount2v3);

      // calculate expected amount in across v2
      const amountIn1v2 = pair_0_1.getInputAmount(
        pair_1_2.getInputAmount(amountv2)[0]
      );
      const amountIn2v2 = pair_weth_0.getInputAmount(
        pair_weth_2.getInputAmount(amount2v2)[0]
      );
      ...
      const expectedIn = amountIn1v2[0]
        .add(amountIn2v2[0])
        .add(amountIn2v3[0])
        .add(amountIn4v3[0]);
    ...
    it('throws if pools are re-used between V3 routes', async () => {
      ...
      //duplicate pool
      const route2OriginalV3 = new V3RouteSDK(
        [pool_0_1, pool_weth_1, pool_weth_2],
        token0,
        token2
      );
      const route2v3 = new RouteV3(route2OriginalV3);
    ...
    it('throws if pools are re-used between V2 routes', async () => {
      ...
      const route2OriginalV2 = new V2RouteSDK(
        [pair_0_1, pair_weth_1, pair_weth_2],
        token0,
        token2
      );
      const route2v2 = new RouteV2(route2OriginalV2);
    ...
    it('throws if pools are re-used between mixed routes and v2 routes', async () => {
      ...
      const mixedRouteOriginal = new MixedRouteSDK(
        [pair_0_1, pool_weth_1, pool_weth_2],
        token0,
        token2
      );
      const mixedRoute = new MixedRoute(mixedRouteOriginal);
    ...
    it('throws if pools are re-used between mixed routes and v3 routes', async () => {
      ...
      const mixedRouteOriginal = new MixedRouteSDK(
        [pool_0_1, pair_weth_1, pool_weth_2],
        token0,
        token2
      );
      const mixedRoute = new MixedRoute(mixedRouteOriginal);
    ...
    it('throws if trade is created with EXACT_OUTPUT and contains mixedRoutes', async () => {
      ...
      const mixedRoute = new MixedRoute(mixedRouteOriginal);
      const mixedRouteAmount = CurrencyAmount.fromRawAmount(
        token1,
        JSBI.BigInt(1000)
      );
  ...
  describe('#worstExecutionPrice', () => {
    describe('tradeType = EXACT_INPUT', () => {
      ...
      it('throws if less than 0', () => {
        expect(() =>
          exactInV3.worstExecutionPrice(new Percent(-1, 100))
        ).toThrow('SLIPPAGE_TOLERANCE');
        expect(() =>
          exactInMixed.worstExecutionPrice(new Percent(-1, 100))
        ).toThrow('SLIPPAGE_TOLERANCE');
      });
      it('returns exact if 0', () => {
        expect(exactInV3.worstExecutionPrice(new Percent(0, 100))).toEqual(
          exactInV3.executionPrice
        );
        expect(exactInMixed.worstExecutionPrice(new Percent(0, 100))).toEqual(
          exactInV3.executionPrice
        );
      });
      it('returns exact if nonzero', () => {
        ...
        expect(exactInV3.worstExecutionPrice(new Percent(5, 100))).toEqual(
          new Price(token0, token2, 100, 65)
        );
        expect(exactInV3.worstExecutionPrice(new Percent(200, 100))).toEqual(
          new Price(token0, token2, 100, 23)
        );
        expect(exactInMixed.worstExecutionPrice(new Percent(0, 100))).toEqual(
          new Price(token0, token2, 100, 69)
        );
        expect(exactInMixed.worstExecutionPrice(new Percent(5, 100))).toEqual(
          new Price(token0, token2, 100, 65)
        );
        expect(exactInMixed.worstExecutionPrice(new Percent(200, 100))).toEqual(
          new Price(token0, token2, 100, 23)
        );
      });
      it('returns exact if nonzero with multiple routes', () => {
        ...
        expect(
          exactInMultiMixedRoute.worstExecutionPrice(new Percent(0, 100))
        ).toEqual(new Price(token0, token2, 100, 69));
        expect(
          exactInMultiMixedRoute.worstExecutionPrice(new Percent(5, 100))
        ).toEqual(new Price(token0, token2, 100, 65));
        expect(
          exactInMultiMixedRoute.worstExecutionPrice(new Percent(200, 100))
        ).toEqual(new Price(token0, token2, 100, 23));
      });
    });
    ...
    describe('worst execution price across v2 and v3 trades exact input', () => {
      ...
      it('throws if less than 0', () => {
        expect(() => exactIn.worstExecutionPrice(new Percent(-1, 100))).toThrow(
          'SLIPPAGE_TOLERANCE'
        );
      });
      it('returns exact if 0', () => {
    ...
    describe('worst execution price across only mixedRoute trades exact input', () => {
      ...
      const mixedRoute2 = new MixedRouteSDK(
        [pair_0_1, pool_weth_1, pool_weth_2],
        token0,
        token2
      );
      ...
      it('returns exact if nonzero', () => {
        expect(exactIn.worstExecutionPrice(new Percent(0, 100))).toEqual(
          new Price(token0, token2, 256, 200)
        );
        expect(exactIn.worstExecutionPrice(new Percent(5, 100))).toEqual(
          new Price(token0, token2, 256, 190)
        );
        expect(exactIn.worstExecutionPrice(new Percent(200, 100))).toEqual(
          new Price(token0, token2, 256, 66)
        );
      });
    });
  ...
  describe('#minimumAmountOut', () => {
    describe('tradeType = EXACT_INPUT', () => {
      ...
      it('throws if less than 0', () => {
        expect(() =>
          trade.minimumAmountOut(new Percent(JSBI.BigInt(-1), 100))
        ).toThrow('SLIPPAGE_TOLERANCE');
      });

      it('returns exact if 0', () => {
        expect(
          trade.minimumAmountOut(new Percent(JSBI.BigInt(0), 100))
        ).toEqual(trade.outputAmount);
      });

      it('returns exact if nonzero', () => {
        expect(
          trade.minimumAmountOut(new Percent(JSBI.BigInt(5), 100))
        ).toEqual(
          CurrencyAmount.fromRawAmount(token1, 285) // 300 * 0.95
        );
        expect(
          trade.minimumAmountOut(new Percent(JSBI.BigInt(200), 100))
        ).toEqual(CurrencyAmount.fromRawAmount(token1, 100));
      });
      ...
      describe('tradeType = EXACT_OUTPUT', () => {
        ...
        it('returns exact if nonzero', () => {
          expect(
            trade.minimumAmountOut(new Percent(JSBI.BigInt(5), 100))
          ).toEqual(CurrencyAmount.fromRawAmount(token1, 200));
        });
      });
    });
  });
  ...
  describe('#maximumAmountIn', () => {
    describe('tradeType = EXACT_INPUT', () => {
      ...
      it('throws if less than 0', () => {
        expect(() =>
          trade.maximumAmountIn(new Percent(JSBI.BigInt(-1), 100))
        ).toThrow('SLIPPAGE_TOLERANCE');
      });

      it('returns exact if 0', () => {
        expect(trade.maximumAmountIn(new Percent(JSBI.BigInt(0), 100))).toEqual(
          trade.inputAmount
        );
      });
      ...
      describe('tradeType = EXACT_OUTPUT', () => {
        ...
        it('returns exact if 0', () => {
          expect(
            trade.maximumAmountIn(new Percent(JSBI.BigInt(0), 100))
          ).toEqual(trade.inputAmount);
        });

        it('returns exact if nonzero', () => {
          expect(
            trade.maximumAmountIn(new Percent(JSBI.BigInt(5), 100))
          ).toEqual(CurrencyAmount.fromRawAmount(token0, 210));
          expect(
            trade.maximumAmountIn(new Percent(JSBI.BigInt(200), 100))
          ).toEqual(CurrencyAmount.fromRawAmount(token0, 600));
        });
      });
    });
  });
  ...
  describe('#priceImpact', () => {
    ...
    describe('tradeType = EXACT_INPUT', () => {
      ...
      it('is correct', () => {
        ...
        expect(mixedTrade.priceImpact.toSignificant(3)).toEqual(
  ...
  describe('#executionPrice', () => {
    it('is correct for tradeType = EXACT_INPUT', async () => {
      ...
      const mixedRouteOriginal = new MixedRouteSDK(
        [pair_weth_0, pool_weth_1],
        token0,
        token1
      );
      const mixedRoute = new MixedRoute(mixedRouteOriginal);
      const amountMixed = CurrencyAmount.fromRawAmount(
        token0,
        JSBI.BigInt(100)
      );

      const expectedOutV3 = await pool_0_1.getOutputAmount(amountv3);
      const expectedOutMixed = await pool_weth_1.getOutputAmount(
        (
          await pair_weth_0.getOutputAmount(amountMixed)
        )[0]
      );
      const expectedOut = expectedOutV3[0]
        .add(pair_0_1.getOutputAmount(amountv2)[0])
        .add(expectedOutMixed[0]);
    ...
    it('is correct for tradeType = EXACT_OUTPUT', async () => {
      ...
      const expectedIn = expectedInV3[0].add(
        pair_0_1.getInputAmount(amountv2)[0]
      );
