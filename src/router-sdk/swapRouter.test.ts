  ...
  describe('#swapCallParameters', () => {
    ...
    describe('single-hop exact output (v2 + v3)', () => {
      describe('different trade configurations result in identical calldata', () => {
        ...
        const v2Trade = V2Trade.exactOut(
          new V2Route([pair_0_1], token0, token1),
          amountOut
        );
        const v3Trade = V3Trade.fromRoute(
    ...
    describe('multi-hop exact input (v2 + v3)', () => {
      describe('different trade configurations result in identical calldata', () => {
        ...
        const v2Trade = V2Trade.exactIn(
          new V2Route([pair_0_1, pair_1_WETH], token0, WETH),
          amountIn
        );
        const v3Trade = V3Trade.fromRoute(
      ...
      describe('single-hop exact input (v2 + v3) backwards compatible', () => {
        describe('different trade configurations result in identical calldata', () => {
          ...
          it('generates the same calldata', async () => {
            ...
            const mixedRouteTrades = [
              await mixedRouteTrade1,
              await mixedRouteTrade2,
            ];
            const { calldata: mixedRouteCalldata, value: mixedRouteValue } =
              SwapRouter.swapCallParameters(mixedRouteTrades, {
                slippageTolerance,
                recipient,
                deadlineOrPreviousBlockhash: deadline,
              });
          ...
          it('meta-trade', async () => {
            ...
            const mixedRouteTrades = await Trade.fromRoutes(
              [],
              [],
              TradeType.EXACT_INPUT,
              [
    ...
    describe('ETH input', () => {
      describe('single-hop exact input (v2 + v3)', () => {
        describe('different trade configurations result in identical calldata', () => {
          ...
          const v2Trade = V2Trade.exactIn(
            new V2Route([pair_1_WETH], ETHER, token1),
            amountIn
          );
          const v3Trade = V3Trade.fromRoute(
      ...
      describe('multi-hop exact input (v2 + v3)', () => {
        describe('different trade configurations result in identical calldata', () => {
          ...
          const v2Trade = V2Trade.exactIn(
            new V2Route([pair_1_WETH, pair_0_1], ETHER, token0),
            amountIn
          );
      ...
      describe('high price impact with ERCO20 input does not result in refundETH call', () => {
        ...
        const v2Trade = V2Trade.exactIn(
          new V2Route([pair_1_WETH], token1, WETH),
          amountIn
        );
        const v3Trade = V3Trade.fromRoute(
    ...
    describe('ETH output', () => {
      describe('single-hop exact input (v2 + v3)', () => {
        describe('different trade configurations result in identical calldata', () => {
          ...
          const v2Trade = V2Trade.exactIn(
            new V2Route([pair_1_WETH], token1, ETHER),
            amountIn
          );
          const v3Trade = V3Trade.fromRoute(
      ...
      describe('multi-hop exact input (v2 + v3)', () => {
        describe('different trade configurations result in identical calldata', () => {
          ...
          const v2Trade = V2Trade.exactIn(
            new V2Route([pair_0_1, pair_1_WETH], token0, ETHER),
            amountIn
          );
          /// mixedRouteTrade mirrors v2Trade
          const mixedRouteTrade = MixedRouteTrade.fromRoute(
    ...
    describe('#swapAndAddCallParameters', () => {
      ...
      describe('when input is native', () => {
        ...
        const v3Trade = V3Trade.fromRoute(
          new V3Route([pool_1_WETH], ETH, token1),
          amountIn,
          TradeType.EXACT_INPUT
        );
        const mixedRouteTrade3 = MixedRouteTrade.fromRoute(
      ...
      describe('when output is native', () => {
        ...
        const v3Trade = V3Trade.fromRoute(
          new V3Route([pool_1_WETH], token1, ETH),
          amountIn,
          TradeType.EXACT_INPUT
        );
        const mixedRouteTrade3 = MixedRouteTrade.fromRoute(
