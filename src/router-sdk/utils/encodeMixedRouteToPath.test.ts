import { CurrencyAmount, Ether, Token, WETH9 } from '../../sdk-core';
import { Pair } from '../../v2-sdk';
import { encodeSqrtRatioX96, FeeAmount, Pool } from '../../v3-sdk';
...
describe('#encodeMixedRouteToPath', () => {
  ...
  const pool_0_1_medium = new Pool(
    token0,
    token1,
    FeeAmount.MEDIUM,
  ...
  const route_0_V3_1_V3_2 = new MixedRouteSDK(
    [pool_0_1_medium, pool_1_2_low],
    token0,
    token2
  );
  const route_0_V3_weth = new MixedRouteSDK([pool_0_weth], token0, ETHER);
  const route_0_V3_1_V3_weth = new MixedRouteSDK(
    [pool_0_1_medium, pool_1_weth],
    token0,
    ETHER
  );
  const route_weth_V3_0 = new MixedRouteSDK([pool_0_weth], ETHER, token0);
  const route_weth_V3_0_V3_1 = new MixedRouteSDK(
  ...
  const route_0_V2_1_V2_2 = new MixedRouteSDK(
    [pair_0_1, pair_1_2],
    token0,
    token2
  );
  const route_weth_V2_0 = new MixedRouteSDK([pair_0_weth], ETHER, token0);
  const route_weth_V2_0_V2_1 = new MixedRouteSDK(
    [pair_0_weth, pair_0_1],
    ETHER,
    token1
  );
  const route_0_V2_weth = new MixedRouteSDK([pair_0_weth], token0, ETHER);
  const route_0_V2_1_V2_weth = new MixedRouteSDK(
    [pair_0_1, pair_1_weth],
    token0,
    ETHER
  );

  const route_0_V3_1_V2_weth = new MixedRouteSDK(
    [pool_0_1_medium, pair_1_weth],
    token0,
    ETHER
  );
  const route_0_V3_weth_V2_1_V2_2 = new MixedRouteSDK(
    [pool_0_weth, pair_1_weth, pair_1_2],
    token0,
    token2
  );
  const route_0_V3_1_v3_weth_V2_2 = new MixedRouteSDK(
    [pool_0_1_medium, pool_1_weth, pair_2_weth],
    token0,
    token2
  );
