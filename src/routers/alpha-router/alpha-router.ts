...
import { Pool, Position, SqrtPriceMath, TickMath } from '../../v3-sdk';
  ...
  ISwapToRatio<AlphaRouterConfig, SwapAndAddConfig>
{
  ...
  constructor({
    ...
    if (v3SubgraphProvider) {
      ...
      const poolUrl =
        chainId == 4689
          ? `https://api.mimo.exchange/api/rest/poolsv3`
  ...
  private async getSwapRouteFromChain(
    ...
    const mixedProtocolAllowed =
      [ChainId.MAINNET, ChainId.GOERLI, ChainId.IOTEX].includes(this.chainId) &&
    ...
    console.log("allRoutesWithValidQuotes",)
