...
import { validateAndParseAddress, BigintIsh } from '../../sdk-core';
import { NFTPermitOptions, NonfungiblePositionManager } from '../../v3-sdk';
...
export function encodeV3PositionPermit(
  planner: RoutePlanner,
