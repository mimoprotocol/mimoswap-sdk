...
import { FACTORY_ADDRESS } from '../v3-sdk';
...
export const V3_CORE_FACTORY_ADDRESSES: AddressMap = {
  ...
  [ChainId.IOTEX]: CHAIN_TO_ADDRESSES_MAP[ChainId.IOTEX].v3CoreFactoryAddress,
...
export const QUOTER_V2_ADDRESSES: AddressMap = {
  ...
  [ChainId.IOTEX]: CHAIN_TO_ADDRESSES_MAP[ChainId.IOTEX].quoterAddress,
  // TODO: Gnosis + Moonbeam contracts to be deployed
};
...
export const MIXED_ROUTE_QUOTER_V1_ADDRESSES: AddressMap = {
  ...
  [ChainId.IOTEX]:
    CHAIN_TO_ADDRESSES_MAP[ChainId.IOTEX].v1MixedRouteQuoterAddress,
};
...
export const UNISWAP_MULTICALL_ADDRESSES: AddressMap = {
  ...
  [ChainId.IOTEX]: CHAIN_TO_ADDRESSES_MAP[ChainId.IOTEX].multicallAddress,
  // TODO: Gnosis + Moonbeam contracts to be deployed
};
