import { ChainId, Currency, Ether, NativeCurrency, Token } from '../sdk-core';
...
export const NATIVE_CURRENCY: { [chainId: number]: NativeCurrencyName } = {
  ...
  [ChainId.IOTEX]: NativeCurrencyName.ETHER,
};
...
export const ID_TO_PROVIDER = (id: ChainId): string => {
  switch (id) {
    ...
    case ChainId.IOTEX:
      return process.env.JSON_RPC_PROVIDER_IOTEX!;
    default:
