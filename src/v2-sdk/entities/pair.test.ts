    ...
    describe('when calculating FOT fees', () => {
      ...
      describe('getOutputAmount', () => {
        it('getOutputAmount for input token BLASTERS and output token BLAST', () => {
          const reserveBlasterAmount = CurrencyAmount.fromRawAmount(
            BLASTERS,
            '10000'
          );
          const reserveBlastAmount = CurrencyAmount.fromRawAmount(
            BLAST,
            '10000'
          );
          ...
          const inputBlastersAmount = CurrencyAmount.fromRawAmount(
        ...
        it('getInputAmount for input token BLASTERS and output token BLAST', () => {
          ...
          const outputBlastAmount = CurrencyAmount.fromRawAmount(
            BLAST_WIHTOUT_TAX,
            '91'
          );
